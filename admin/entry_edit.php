...
<head>
	...
	<meta charset="utf-8"/>
	<title>Edit Existing Entry | Admin Dashboard</title>
...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="index">Website Admin</a> <div class="breadcrumb_divider"></div> <a class="current">Edit Existing Article</a></article>
		</div>
...
<?php include('entry_edit_main.php'); ?>
	</section>
