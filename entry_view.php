...
<head>
	...
	<meta charset="utf-8"/>
	<title><?php echo $fetched_row['postTitle']; ?></title>
...
<body>
	...
	<header id="header">
		<hgroup>
			...
			<h2 class="section_title"><?php echo $fetched_row['postTitle']; ?></h2></div> <!--<div class="btn_view_site"><a href="http://www.medialoot.com">View Site</a>-->
		</hgroup>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="index">Viewing | <?php echo $fetched_row['postTitle']; ?></a></article>
		</div>
...
<?php include('entry_view_main.php'); ?>
	</section>
